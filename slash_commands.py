...
def setup_slash_commands(bot):
    ...
    @bot.tree.command(name="helphumi", description="Show help message for bot commands")
    async def helphumi_slash(interaction: discord.Interaction):
        await handle_helphumi(interaction)
